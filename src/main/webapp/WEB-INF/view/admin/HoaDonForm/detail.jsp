                    ...
                    <div class="col-md-6">
                        ...
                        <div class="container mt-4">
                            <form action="/hoa-don/update/trangthai" method="POST">
                                <div class="mb-3">
                                    <label for="trangThai" class="form-label">Trạng thái mới:</label> <select id="trangThai" name="trangThai" class="form-select" onchange="showHideReason()">
                                    <option value="1">Đã thanh toán</option>
                                    <option value="2">Chờ xác nhận</option>
                                    <option value="3">Đã xác nhận</option>
                                    <option value="4">Đã giao hàng</option>
                                    <option value="5">Hủy hóa đơn</option>
