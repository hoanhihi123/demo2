        ...
        <div class="card">
            <div class="card-header" id="heading-1">
                <h2 class="card-title">Hình thức thanh toán: <br>
                    <input type="radio"  checked value="shipcod" name="hinhThucThanhToan" style="transform: scale(1.5); margin-top: 10px;"> <span style="margin-left: 10px; margin-bottom: 10px;">Thanh toán khi nhận hàng <br></span>
                    <input type="radio"  value="vnpay" name="hinhThucThanhToan" style="transform: scale(1.5); margin-top: 10px;"> <span style="margin-left: 10px; margin-bottom: 10px;">Thanh toán bằng VNPay</span>
                </h2>
            </div><!-- End .card-header -->
        </div><!-- End .card -->
