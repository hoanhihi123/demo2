...
public class QLSanPhamController {
    ...
    public String taoSanPhamChiTiet(
        ...
        kichCoThem = kichCoService.chiTietTheoId(chiTietSP_request.getIdSizeGiay());
            ...
            String urlSaveImageChinh_resource = "C:/Users/admin/DATN-10/SP2024_SD09_DATN_WEBSITE_NICESPORT/src/main/resources/static/user/assets/imagesgiay/" + fileAnhChinh.getOriginalFilename();
...
//            }
          ...
          ChiTietSanPham chiTietSanPhamVuaThem = chiTietSPService.themMoi_traVeKetQua(chiTietSanPhamThemMoi);
            ...
            for(int i=0;i<cacFileAnhCon.length; i++){
                ...
                String urlSaveImageCon_toResource = "C:/Users/admin/DATN-10/SP2024_SD09_DATN_WEBSITE_NICESPORT/src/main/resources/static/user/assets/imagesgiay/"
